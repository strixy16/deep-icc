function opt = all_hcc_tumors
%Description: Configuration file for createCSV for HCC tumor images
%
...
%Updates:
    ...
    opt.Labels = "../../Data/HCC_survival_sorted.xlsx";
    % Header
...
%     opt.Label2 = 'RFS Time'; % Time to recurrence
    ...
    opt.all_file_dir = "../../Data/HCC/tumors/";
    opt.destination_dir = "../../Data/HCC/labelled_only/tumors/";
end